...
import { getSystemPrompt } from '@bolt/agent/lib/common/prompts/prompts';
import { DEFAULT_MODEL, DEFAULT_PROVIDER, MODIFICATIONS_TAG_NAME, WORK_DIR } from '@bolt/agent/utils/constants';
import type { IProviderSetting } from '@bolt/agent/types/model';
import { PromptLibrary } from '@bolt/agent/lib/common/prompt-library';
...
import { discussPrompt } from '@bolt/agent/lib/common/prompts/discuss-prompt';
