      ...
      <View style={styles.section}>
        ...
        <View style={styles.settingsCard}>
          <View style={styles.settingRow}>
            ...
            <Switch value={darkMode} onValueChange={setDarkMode} trackColor={{ false: '#404040', true: '#8A5FFF' }} />
          </View>
        </View>
      </View>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.settingsCard}>
          <View style={styles.settingRow}>
            ...
            <Switch value={autoSave} onValueChange={setAutoSave} trackColor={{ false: '#404040', true: '#8A5FFF' }} />
          </View>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.settingsCard}>
          ...
          <TextInput
            ...
            secureTextEntry
          />
          <Text style={styles.inputHint}>Get your API key from platform.openai.com</Text>
        </View>
      </View>
