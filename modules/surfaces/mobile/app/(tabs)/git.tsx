  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.tabs}>
        ...
        >
          <Text style={[styles.tabText, activeTab === 'contributors' && styles.activeTabText]}>Contributors</Text>
        </TouchableOpacity>
      </View>
            ...
            {mockContributors.map((contributor, index) => (
              <View key={index} style={styles.contributorCard}>
                ...
                <View style={styles.contributorInfo}>
                  ...
                  <Text style={styles.contributorContributions}>{contributor.contributions} contributions</Text>
                </View>
              </View>
            ))}
          </>
