      ...
      <View style={styles.fileExplorer}>
        ...
        <ScrollView style={styles.fileList}>
          {mockFiles.map((file, index) => (
            <TouchableOpacity
              key={index}
              style={[styles.fileItem, selectedFile === file.name && styles.fileItemSelected]}
            ...
            >
              ...
              />
              <Text style={[styles.fileName, selectedFile === file.name && styles.fileNameSelected]}>{file.name}</Text>
            </TouchableOpacity>
          ))}
        </ScrollView>
      </View>
