...
const FEATURE_FEED: FeatureDefinition[] = [
  ...
  },
  {
    ...
    description:
      'The codebase is now split into six ownership modules with independent typecheck, lint, and test commands, enforced dependency boundaries, affected-module validation, and stable service facades for existing self-host deployments.',
  ...
  },
  {
    ...
    description:
      'The protected FREE route now offers MagnetAPI.org ChatGPT-5.6 SOL, Opus 4.8, Sonnet 5, and Fable 5 with in-session switching and model-native Responses or Messages tool calls, while optional settings, PDF, Git, terminal, and plugin code stay off the initial chat path.',
