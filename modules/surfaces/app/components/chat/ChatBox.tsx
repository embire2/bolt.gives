...
import { ExpoQrModal } from '@bolt/project/components/workbench/ExpoQrModal';
...
import { getAutonomyModeLabel, getNextAutonomyMode, type AutonomyMode } from '@bolt/agent/lib/runtime/autonomy';
    ...
    >
      <svg className={classNames(styles.PromptEffectContainer)}>
        <defs>
          ...
          >
            ...
            <stop offset="35%" stopColor="#dc2626" stopOpacity="80%"></stop>
            <stop offset="50%" stopColor="#1e293b" stopOpacity="50%"></stop>
            <stop offset="65%" stopColor="#3b82f6" stopOpacity="80%"></stop>
      ...
      >
        <textarea
          ...
          placeholder={
            props.chatMode === 'build' ? 'How can Cody agent help you today?' : 'What would you like to discuss?'
          }
          translate="no"
        />
        <ClientOnly>
