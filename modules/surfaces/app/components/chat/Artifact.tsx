...
import type { ActionState } from '@bolt/project/lib/runtime/action-runner';
...
import { toWorkbenchAbsoluteFilePath, toWorkbenchRelativeFilePath } from '@bolt/core/lib/runtime/file-paths';
