import type { ActionType } from '@bolt/core/types/actions';
import type { ActionStatus } from '@bolt/project/lib/runtime/action-runner';
import type { StarterTemplateBootstrapCommands } from '@bolt/agent/utils/selectStarterTemplate';
