...
import { DEFAULT_MODEL, DEFAULT_PROVIDER, PROMPT_COOKIE_KEY, PROVIDER_LIST } from '@bolt/agent/utils/constants';
import { cubicEasingFn } from '@bolt/core/utils/easings';
import { createScopedLogger, renderLogger } from '@bolt/core/utils/logger';
import Cookies from 'js-cookie';
import { debounce } from '@bolt/core/utils/debounce';
...
} from '@bolt/agent/utils/selectStarterTemplate';
...
import { useMCPStore } from '@bolt/project/lib/stores/mcp';
import type { ActionAlert, LlmErrorAlertType } from '@bolt/core/types/actions';
import { buildModelSelectionEnvelope, selectModelForPrompt } from '@bolt/agent/lib/runtime/model-orchestrator';
import type { ModelInfo } from '@bolt/agent/lib/modules/llm/types';
import { recordTokenUsage } from '@bolt/project/lib/stores/performance';
import { mergePromptContext } from '@bolt/project/lib/services/prompt-merge';
import { LOCAL_PROVIDERS } from '@bolt/project/lib/stores/settings';
import {
...
} from '@bolt/agent/lib/runtime/model-selection';
import { normalizeUsageEvent } from '@bolt/agent/lib/runtime/cost-estimation';
import type { ArchitectDiagnosis } from '@bolt/agent/lib/runtime/architect';
import type { AgentMode, AgentPlanStep } from '@bolt/agent/lib/runtime/agent-workflow';
import type { InteractiveStepRunnerEvent } from '@bolt/agent/lib/runtime/interactive-step-runner';
import { getLastMeaningfulProgressTimestamp } from '@bolt/agent/lib/runtime/stall-progress';
import {
...
} from '@bolt/agent/lib/runtime/stall-policy';
import {
...
import type { TextFileSnapshot } from '@bolt/agent/lib/runtime/agent-file-diffs';
...
const HOSTED_FREE_DEFAULT_STREAM_DEADLINE_MS = 300000;
...
const loadSessionManager = () => import('@bolt/project/lib/services/sessionManager');
const loadSessionPayloadModule = () => import('@bolt/project/lib/services/session-payload');
const loadArchitectModule = () => import('@bolt/agent/lib/runtime/architect');
const loadAgentWorkflowModule = () => import('@bolt/agent/lib/runtime/agent-workflow');
const loadAgentFileDiffsModule = () => import('@bolt/agent/lib/runtime/agent-file-diffs');
const loadStarterBootstrapModule = () => import('@bolt/agent/lib/runtime/starter-bootstrap');
const loadMutatingIntentModule = () => import('@bolt/agent/lib/runtime/mutating-intent');
