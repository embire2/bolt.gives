...
import { useGit } from '@bolt/project/lib/hooks/useGit';
import type { Message } from 'ai';
import { detectProjectCommands, createCommandsMessage, escapeBoltTags } from '@bolt/core/utils/projectCommands';
...
import type { IChatMetadata } from '@bolt/project/lib/persistence/db';
...
${escapeBoltTags(file.content)}
  ...
  return (
    <>
      ...
      {loading && (
        <LoadingOverlay
          className="text-bolt-elements-textPrimary dark:text-bolt-elements-textPrimary"
