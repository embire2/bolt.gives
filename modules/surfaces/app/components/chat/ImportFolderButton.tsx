...
import { MAX_FILES, isBinaryFile, shouldIncludeFile } from '@bolt/project/utils/fileUtils';
import { createChatFromFolder } from '@bolt/project/utils/folderImport';
import { logStore } from '@bolt/project/lib/stores/logs'; // Assuming logStore is imported from this location
