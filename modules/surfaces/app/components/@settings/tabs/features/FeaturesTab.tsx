...
import { PluginManager, type PluginManifest } from '@bolt/project/lib/services/pluginManager';
import { generateDeploymentFiles, type DeploymentProvider } from '@bolt/project/lib/services/deploymentWizard';
