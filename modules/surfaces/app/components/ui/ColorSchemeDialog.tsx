...
import { defaultDesignScheme, designFeatures, designFonts, paletteRoles } from '@bolt/core/types/design-scheme';
                ...
                style={{
                  ...(f.key === 'gradient' && {
                    background: isSelected
                      ? 'linear-gradient(135deg, var(--bolt-gradient-red) 0%, var(--bolt-gradient-blue) 100%)'
                  ...
                  <div className="flex items-center justify-center w-12 h-12 rounded-xl bg-bolt-elements-bg-depth-1 bg-opacity-20">
                    ...
                    {f.key === 'gradient' && (
                      <div
                        ...
                        style={{
                          background: 'linear-gradient(135deg, var(--bolt-gradient-red), var(--bolt-gradient-blue))',
                        }}
                      />
                    )}
                    {f.key === 'shadow' && (
