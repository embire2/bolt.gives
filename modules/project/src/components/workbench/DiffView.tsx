...
import type { EditorDocument } from '@bolt/project/components/editor/codemirror/CodeMirrorEditor';
import { diffLines, type Change } from 'diff';
import '~/styles/diff-view.css';
import { diffFiles, extractRelativePath } from '@bolt/core/utils/diff';
