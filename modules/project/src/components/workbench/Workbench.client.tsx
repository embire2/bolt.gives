...
import { getLanguageFromExtension } from '@bolt/project/utils/getLanguageFromExtension';
import type { FileHistory } from '@bolt/core/types/actions';
import type { JSONValue } from 'ai';
import {
  type OnChangeCallback as OnEditorChange,
  type OnScrollCallback as OnEditorScroll,
} from '@bolt/project/components/editor/codemirror/CodeMirrorEditor';
import { IconButton } from '~/components/ui/IconButton';
import { Slider, type SliderOptions } from '~/components/ui/Slider';
import { workbenchStore, type WorkbenchViewType } from '@bolt/project/lib/stores/workbench';
import { classNames } from '@bolt/core/utils/classNames';
import { cubicEasingFn } from '@bolt/core/utils/easings';
import { renderLogger } from '@bolt/core/utils/logger';
import useViewport from '@bolt/project/lib/hooks';

import { usePreviewStore } from '@bolt/project/lib/stores/previews';
