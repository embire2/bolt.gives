...
import type { Theme } from '@bolt/core/types/theme';
...
import { isFileLocked, getCurrentChatId } from '@bolt/project/utils/fileLocks';
...
import { isCollaborationEnabled } from '@bolt/project/lib/collaboration/config';
  ...
  ({
    ...
    useEffect(() => {
      ...
      if (!collaborationEnabled) {
        ...
        void import('@bolt/project/lib/collaboration/client').then(
