...
import { gitHubApiService } from '@bolt/project/lib/services/githubApiService';
import { calculateStatsSummary } from '@bolt/project/utils/githubStats';
import type { GitHubConnection } from '@bolt/core/types/GitHub';
