...
import { bufferWatchEvents } from '@bolt/core/utils/buffer';
import { WORK_DIR } from '@bolt/core/constants/workspace';
import { computeFileModifications } from '@bolt/core/utils/diff';
import { createScopedLogger } from '@bolt/core/utils/logger';
import { unreachable } from '@bolt/core/utils/unreachable';
import type { File, FileMap } from '@bolt/core/types/files';
import {
  addLockedFile,
  removeLockedFile,
  addLockedFolder,
...
export type { File, FileMap, Folder } from '@bolt/core/types/files';
