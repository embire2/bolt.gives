...
import { GitLabApiService } from '@bolt/project/lib/services/gitlabApiService';
import { calculateStatsSummary } from '@bolt/project/utils/gitlabStats';
import type { GitLabConnection, GitLabStats } from '@bolt/core/types/GitLab';
