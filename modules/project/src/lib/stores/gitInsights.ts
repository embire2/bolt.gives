...
import {
  gitHubApiService,
  type CommitHeatmapData,
  type AuthorStats,
} from '@bolt/project/lib/services/githubApiService';
import { analysisService, type AnalysisResult } from '@bolt/project/lib/services/analysisService';
