...
import { path as nodePath } from '@bolt/core/utils/path';
...
import type { BoltShell } from '@bolt/project/utils/shell';
import {
  InteractiveStepRunner,
  type InteractiveStep,
  type InteractiveStepRunnerEvent,
} from '@bolt/agent/lib/runtime/interactive-step-runner';
