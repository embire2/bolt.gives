...
import type { GitHubUserResponse, GitHubConnection } from '@bolt/core/types/GitHub';
import { useGitHubAPI } from './useGitHubAPI';
import { githubConnection, isConnecting, updateGitHubConnection } from '@bolt/project/lib/stores/github';
