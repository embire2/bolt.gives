...
import type { GitLabConnection } from '@bolt/core/types/GitLab';
import { useGitLabAPI } from './useGitLabAPI';
import { gitlabConnectionStore, gitlabConnection, isGitLabConnected } from '@bolt/project/lib/stores/gitlabConnection';
