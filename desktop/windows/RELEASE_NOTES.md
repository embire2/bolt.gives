...
- Pins both the legacy and current Microsoft ID Verified Artifact Signing hierarchies while still requiring the expected bolt.gives publisher identity and timestamp.
