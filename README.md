...
- The browser also honors the server-advertised 150-second absolute FREE deadline through a sampler that stays mounted while stream counters change, ensuring commentary or reasoning-only text cannot suppress recovery indefinitely.
