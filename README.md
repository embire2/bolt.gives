...
- The browser also honors the server-advertised 150-second absolute FREE deadline, ensuring commentary or reasoning-only text cannot suppress recovery indefinitely.
