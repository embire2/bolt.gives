...
- [~] P0.5 Reliability Guardrails for Web/Tool Tasks (partial)
  - Strict tool schema compatibility fix landed (`83b7857`) for `web_search` schema validation issues.
  - Remaining work: full cross-provider regression suite and compatibility matrix.
- [ ] P0.3 Execution Transparency Panel
- [ ] P0.4 Safer Autonomy Modes
- [ ] P1.6 Persistent Project Memory (Scoped)
- [ ] P1.7 Sub-Agent Framework (Minimal)
