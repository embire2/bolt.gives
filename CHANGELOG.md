...
- A preview document caught in the brief old-port handoff window now receives a repair page that polls for a healthy owned target before navigating, instead of reloading stale Vite assets into HTTP 409 responses; asset and cross-session ownership checks remain strict.
