...
- Passed typecheck, lint, 1,136 tests with 9 intentional skips, a production build and bundle budgets, plus a real Chromium generation/follow-up/interaction smoke.
