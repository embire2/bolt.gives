...
- Hosted FREE streams now also have a 150-second wall-clock deadline, so upstream providers that encode hidden reasoning as ordinary chunks cannot keep a non-productive request alive indefinitely.
