...
- Prevented persistent healthy Preview dev servers from starving managed Cloudflare fleet refreshes. Automatic rollouts still yield to foreground commands, Preview recovery, and runtime-node provisioning, but idle open Previews no longer leave new provisioning blocked behind a stale live release.
