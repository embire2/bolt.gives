...
- [x] Unblock hosted starter model continuation when Preview becomes healthy and require a successful selected-model request in Calendar release acceptance.
