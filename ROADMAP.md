...
| --------------- | ------------------------------------------------------------------------------------------------------------------------- | ---------------------------- | ------------------------------------------------------------------------------------------------------------------------- |
| [~] B01a / B01b | Implemented shared source exclusions, bounded disk/transport reads, symlink checks, and payload/timing measurements       | runtime/project/core         | No `.cache`, `.local`, or nested dependencies in source snapshots; `.github` retained; reproducible memory/payload limits |
| [~] B02a / B02b | Implemented disk reconciliation, concurrent-write retry, durable IndexedDB completion, and restart-event error handling   | runtime/project              | Same-count edits, rename/delete, follow-up, reload, and restart all return current source                                 |
