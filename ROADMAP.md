...
- [x] Release chat network readers independently of SDK lifetime and preserve bounded asset reads across longer rebuild handoffs. Keep cancellation, failure and foreign-port rejection covered by regressions.
