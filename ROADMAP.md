...
- [x] Keep automatic managed-instance refreshes moving past idle healthy Preview servers while still yielding to foreground commands, recovery work, and runtime-node provisioning.
