...
- [x] Reject false managed-fleet rollout success when a Cloudflare deployment remains queued or its production alias still serves an older version. Require exact-version health from the deployment URL and canonical alias before updating current/last-good state.
